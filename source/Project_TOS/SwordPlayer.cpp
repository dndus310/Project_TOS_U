...
void ASwordPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("MoveForward"), this, &ASwordPlayer::MoveForward);
	PlayerInputComponent->BindAxis(TEXT("MoveRight"), this, &ASwordPlayer::MoveRight);
...
void ASwordPlayer::SmoothLookat()
{
	...
	if (IsInputLook)
	{
		...
		AddMovementInput(LookDir, Scale);
	}
}
...
void ASwordPlayer::MoveForward(float Value)
{
...
void ASwordPlayer::MoveRight(float Value)
{
